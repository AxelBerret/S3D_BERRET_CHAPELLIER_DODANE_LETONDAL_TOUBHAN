    ...
    <li class="tweet">
        <div class="tweet-header">
            <div class="tweet-user-info">
                <a href='dispatcher.php?action=afficherMurUtilisateur&idtouite={$row['id_utilisateur']}' style='text-decoration: none; color: white;'>
...
HTML;
        if(isset($_SESSION['user_id'])){
            echo <<<HTML
                    <li><a href="HTML/accueil.html"><img src="images/icon_accueil.png" alt="" class="menu-icon">Accueil</a></li>
                    <li><a href="HTML/tendances.html"><img src="images/icon_tendances.png" alt="" class="menu-icon">Tendances</a></li>
                    <li><a href="dispatcher.php?action=afficherTouiteDetail&idtouite={$_SESSION['user_id']}"><img src="images/profil.png" alt="" class="menu-icon">Profil</a></li>
                </ul>
...
HTML;
        if (isset($_SESSION['user_id'])) {
            echo <<<HTML
                    <li><a href="HTML/accueil.html"><img src="images/icon_accueil.png" alt="" class="menu-icon">Accueil</a></li>
                    <li><a href="HTML/tendances.html"><img src="images/icon_tendances.png" alt="" class="menu-icon">Tendances</a></li>
                    <li><a href="HTML/profil.html"><img src="images/profil.png" alt="" class="menu-icon">Profil</a></li>
                </ul>
                <div class="profile-module">
                <div class="profile-username">@$nom $prenom</div>
                </div>
